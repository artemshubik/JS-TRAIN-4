...
function generateStringFromCharCode(code1, code2, code3, code4, code5) {
  ...
  let char3 = String.fromCharCode(code3);
  let char4 = String.fromCharCode(code4);
  let char5 = String.fromCharCode(code5);
...
function generateStringFromCodePoint(code1, code2, code3, code4) {
  ...
  let char1 = String.fromCodePoint(code1);
  let char2 = String.fromCodePoint(code2);
  let char3 = String.fromCodePoint(code3);
  let char4 = String.fromCodePoint(code4);
